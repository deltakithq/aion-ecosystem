...
export function SessionsPage(props: {
  ...
  return (
    <section className="grid min-h-0 w-full overflow-auto" aria-label="Sessions">
      <div className="min-w-[900px] border-b border-border bg-card">
        <div className="grid min-h-10 grid-cols-[minmax(220px,1.3fr)_180px_120px_120px_56px] items-center gap-4 border-b border-border px-5 text-[11px] font-semibold uppercase tracking-normal text-muted-foreground">
          <span>Session</span>
          <span>Agent</span>
          <span>Messages</span>
          <span>Updated</span>
        ...
        {props.sessions.map((session) => (
          <div
            className={cn(
              "grid min-h-14 w-full min-w-0 grid-cols-[minmax(220px,1.3fr)_180px_120px_120px_56px] items-center gap-4 border-b border-border px-5 text-left text-muted-foreground hover:bg-accent hover:text-accent-foreground",
