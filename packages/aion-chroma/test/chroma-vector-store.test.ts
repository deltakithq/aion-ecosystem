import { type Embedding, type EmbeddingModel, embedDocuments, vectorFilter } from "@deltakit/aion";
...
describe("ChromaVectorStore", () => {
  it("connects, upserts precomputed embeddings, and queries with Aion embeddings", async () => {
